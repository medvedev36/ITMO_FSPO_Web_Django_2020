...
Реализация веб-приложения на джанго в соответствии с вариантом из практики с Татьяной Николаевной. 
...
#### Этап 1
Подготовить модель данных (миниум 5 таблиц) и набор интерфейсов (минимум 5 интрефейсов), которые Вы хотите сделать в рамках выполнения работы и согласовать с преподавателем.
#### Этап 2
Ознакомится с видеоматериаолами и другими мануалами, вспомнить практики и написать программный код.
#### Этап 3
