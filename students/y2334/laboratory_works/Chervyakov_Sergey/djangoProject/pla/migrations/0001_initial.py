# Generated by Django 3.1.3 on 2020-11-04 13:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fio_ceo', models.CharField(db_index=True, max_length=100)),
            ],
        ),
        migrations.CreateModel(
            name='Relationship',
            fields=[
                ...
                ('attraction_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pla.attraction')),
                ('platform_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pla.platform')),
            ],
        ),
        migrations.CreateModel(
            name='Price',
            fields=[
                ...
                ('Relationship_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pla.relationship')),
            ],
        ),
        migrations.CreateModel(
            name='Operation',
