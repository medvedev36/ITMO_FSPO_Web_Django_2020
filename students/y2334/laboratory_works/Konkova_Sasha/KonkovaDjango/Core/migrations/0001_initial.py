    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fuel_type', models.CharField(choices=[(1, 'Мелкое правонарушение'), (2, 'Среднее правонарушение'), (3, 'Серьёзное правонарушение'), (4, 'Тяжелое правонарушение')], max_length=100)),
