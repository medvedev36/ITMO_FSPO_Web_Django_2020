# Generated by Django 3.0.3 on 2020-06-26 11:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='applications', to='django_app.Auto', verbose_name='Автомобиль')),
                ('workshop', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='django_app.Workshop', verbose_name='Мастерская')),
            ],
            options={
