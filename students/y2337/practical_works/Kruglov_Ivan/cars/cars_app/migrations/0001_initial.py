    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cars_app.owner')),
            ],
        ),
        migrations.AddField(
            model_name='owner',
            name='cars',
            field=models.ManyToManyField(through='cars_app.OwnerShip', to='cars_app.Car'),
        ),
        migrations.AddField(
            model_name='owner',
            name='user',
