    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'unique': 'Already exists'}, max_length=150, unique=True, validators=[django.contrib.auth.validators.UnicodeUsernameValidator()], verbose_name='username')),
                ...
                ('Пасспорт', models.IntegerField(null=True, unique=True)),
                ('Адресс', models.CharField(max_length=128, null=True)),
                ('Национальноть', models.CharField(max_length=48, null=True)),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('start', models.DateField(verbose_name='Начало владения')),
                ('finish', models.DateField(verbose_name='Продажа')),
        ...
        migrations.AddField(
            model_name='owner',
            name='cars',
            field=models.ManyToManyField(through='core.OwnerShip', to='core.Car'),
        ),
        migrations.AddField(
            model_name='owner',
            name='user',
