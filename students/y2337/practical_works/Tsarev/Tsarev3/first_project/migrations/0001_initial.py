    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='first_project.auto')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='first_project.owner')),
            ],
        ),
        migrations.CreateModel(
            name='Certification',
        ...
        migrations.AddField(
            model_name='auto',
            name='own',
            field=models.ManyToManyField(through='first_project.Possession', to='first_project.Owner'),
        ),
    ]
